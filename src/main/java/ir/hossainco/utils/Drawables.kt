...
object Drawables {
	...
	fun createPaddingDrawable(
		...
		createPaddingDrawable(dp2px(left), dp2px(top), dp2px(right), dp2px(bottom), *drawables)
	...
	fun createRectGradient(color: Int, borderColor: Int, border: Float, corner: Float) =
		createGradientDrawable(GradientDrawable.RECTANGLE, color, borderColor, border, corner)
	...
	fun createRect3D(
		...
		back = if (difference == 0f) null else createRectDrawable(backColor, borderColor, border, corner),
		padding = padding,
	...
	fun createOval3D(
		...
		back = if (difference == 0f) null else createOvalDrawable(backColor, borderColor, border),
		padding = padding,
		difference = difference
	)
	...
	fun createRectGradientButton(
		...
		secondary = createRectGradient(secondaryBackColor, secondaryBorderColor, border, corner),
		disabled = createRectGradient(disabledBackColor, disabledBorderColor, border, corner)
	)
	...
	fun createRect3DButton(
		...
		primary = createRect3D(primaryColor, secondaryColor, disabledColor, border, corner, padding, difference),
		secondary = createRect3D(secondaryColor, disabledColor, disabledColor, border, corner, padding, difference / 2f),
	...
	fun createOval3DButton(
		...
		primary = createOval3D(primaryColor, secondaryColor, disabledColor, border, padding, difference),
		secondary = createOval3D(secondaryColor, disabledColor, disabledColor, border, padding, difference / 2f),
